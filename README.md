...
local vk_icon = getMaterial("luna_menus/esc/rules")
...
local newlogosup1 = getMaterial("luna_sup_brand/logofist")
local newlogosup2 = getMaterial("luna_sup_brand/logofist1")

AdminIcons = {}
AdminIcons["Director"] = "groups/group_ceo"
AdminIcons["superadmin"] = "groups/group_developer"
AdminIcons["admin"] = "groups/group_admin"
AdminIcons["Iventolog"] = "groups/group_manager"
...
local function ToggleScoreboard()
	...
	local parsed = markup.Parse("<font=luna.MontBase24Markup><colour=145, 145, 145,255>Онлайн сервера: <colour=203, 39, 44,255>" .. #allPlayers .. "</colour> • Карта: <colour=203, 39, 44,255>" .. currentMap .. "</colour></colour></font>")
	...
	Scoreboard.Paint = function(self, w, h)
		...
		-- draw.SimpleText(#allPlayers, luna.MontBase24, ResponsiveX(1603), ResponsiveY(1030), Color(203, 39, 44), 0, 1)
		-- draw.SimpleText("• Карта: ", luna.MontBase24, ResponsiveX(1620), ResponsiveY(1030), Color(145, 145, 145), 0, 1)
		-- draw.SimpleText(currentMap, luna.MontBase24, ResponsiveX(1695), ResponsiveY(1030), Color(203, 39, 44), 0, 1)
	...
	steambtn.DoClick = function()
		...
		gui.OpenURL("https://steamcommunity.com/sharedfiles/filedetails/?id=3383486673")
	end
	...
	discordbtn.DoClick = function()
		surface.PlaySound('luna_ui/click2.wav')
		gui.OpenURL("https://discord.gg/XTvSdauZG2")
	end
	...
	vkbtn.DoClick = function()
		surface.PlaySound('luna_ui/click2.wav')
		gui.OpenURL("https://sites.google.com/view/bloody-swrp")
	end
